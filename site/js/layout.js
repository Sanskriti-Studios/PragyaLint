...
(function () {
  ...
  var ICONS = [
    ...
    { href: "https://marketplace.visualstudio.com/items?itemName=Abhinu.pragyalint", fa: "fa-solid fa-code", label: "Extension", title: "PragyaLint for Visual Studio Code", external: true },
  ];
  ...
  function injectFooter() {
    ...
    foot.outerHTML =
      ...
      '<a href="https://marketplace.visualstudio.com/items?itemName=Abhinu.pragyalint" target="_blank" rel="noopener" aria-label="PragyaLint for Visual Studio Code" title="PragyaLint for Visual Studio Code"><i class="fa-solid fa-code"></i></a>' +
      "</span>" +
      "</div></footer>";
  }
