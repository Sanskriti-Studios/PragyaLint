...
write(f"{D}/source.html", "Source & releases", "Repository layout, releases, and versioning for PragyaLint.", '''
        ...
        <p>
          ...
          publishes when a commit message contains <code>release:</code>
          (e.g. <code>release: v0.1.3</code>); <code>bins.yml</code> builds the
          platform binaries in parallel on native runners.
        </p>
